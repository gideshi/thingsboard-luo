...
public class UUIDConverterTest {
    ...
    public void basicUuidToStringTest() {
        UUID original = UUID.fromString("8c5b1880-be67-11e9-bfea-4da4715318fb");
    ...
    public void basicStringToUUIDTest() {
        UUID result = UUIDConverter.fromString("1e9bee70a114ea0bfea4da4715318fb");
        Assert.assertEquals(UUID.fromString("58e0a7d7-eebc-11d8-9669-0800200c9a66"), result);
    }

    @Test(expected = IllegalArgumentException.class)
    public void nonV1UuidToStringTest() {
        UUIDConverter.fromTimeUUID(UUID.fromString("8ff9afab-2123-2e6b-25b5-1822074454a6"));
    }
